			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $ayarcek['ayar_tel'] ?> <br> </li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						<a href="http://twitter.com/minimalthemes" class="ftwitter"><?php echo $ayarcek['ayar_twitter'] ?></a>
						<a href="http://www.facebook.com/pages/Minimal-Themes/264056723661265" class="ffacebook"><?php echo $ayarcek['ayar_facebook'] ?></a>
